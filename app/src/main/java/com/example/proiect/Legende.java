...
public class Legende extends AppCompatActivity {
    ...
    private void setAdapter() {
        setOnClickListener();
        RecyclerAdapter adapter = new RecyclerAdapter(descriptionsList, listener);
    ...
    private void setdescriptionsInfo(){
        ...
        descriptionsList.add(new Description("Zburatorul", R.drawable.l2,"Zburatorul este considerat o fiinta fabuloasa. El este reprezentat de un tanar ce apare in visele fetelor nemaritate. Aceasta fiinta apare si in folclorul sumerian, spre exemplu. Insa aici este vorba de succubus. Acesta este un demon cu chip de femeie ce chinuie barbatii.\n" +
        ...
        descriptionsList.add(new Description("Balada Mesterului Manole ", R.drawable.l3,"Balada Mesterului Manole este atat mit, cat si istorie. Caci Manastirea Curtea de Arges exista in realitate. Cat de real este sacrificiul nu stim.\n" +
